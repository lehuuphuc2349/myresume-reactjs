            ...
            <div className="resume-container">
                <div className="technical-skill">
                    <div className="three-tech">
                        <h1><span>Technical Skill</span></h1>
                    </div>
                    <div className="seven-tech">
                        ...
                        <h1>FrameWorks and PlatForms</h1>
                         <ul className="technical-nav">
                            ...
                            <li className="technical-items"> - Entity FrameWork, Winforms/Java Swing</li>
                        </ul>
                        <h1>Database Management Systems</h1>
                        <ul className="technical-nav">
                            <li className="technical-items"> - MongoDB, MS SQL Sever, MySQL</li>
                        </ul>
                        ...
                        <ul className="technical-nav">
                            <li className="technical-items"> - Visual Studio Code, Atom, Sublime Text, Netbeans, Visual Studio</li>
                        </ul>
                    </div>
                </div>
            </div>
